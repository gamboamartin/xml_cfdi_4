...
class indexTest extends test {
    public function test_complemento_pago(): void
    {
        ...
        $data_pagos['pagos'][0]['docto_relacionado'][1]['id_documento'] = '16c7d351-d88b-4b7e-bb6b-f8c3d5cc6cde';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['folio'] = '921';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['moneda_dr'] = 'MXN';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['equivalencia_dr'] = '1';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['num_parcialidad'] = '1';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['imp_saldo_ant'] = '1740';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['imp_pagado'] = '1740';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['imp_saldo_insoluto'] = '0';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['objeto_imp_dr'] = '02';
        $data_pagos['pagos'][0]['docto_relacionado'][1]['impuestos_dr'][0]['traslados_dr'][0]['traslado_dr'][0]['base_dr'] = '1500' ;
        $data_pagos['pagos'][0]['docto_relacionado'][1]['impuestos_dr'][0]['traslados_dr'][0]['traslado_dr'][0]['impuesto_dr'] = '002' ;
        $data_pagos['pagos'][0]['docto_relacionado'][1]['impuestos_dr'][0]['traslados_dr'][0]['traslado_dr'][0]['tipo_factor_dr'] = 'xxx' ;
        $data_pagos['pagos'][0]['docto_relacionado'][1]['impuestos_dr'][0]['traslados_dr'][0]['traslado_dr'][0]['tasa_o_cuota_dr'] = '0.160000' ;
        $data_pagos['pagos'][0]['docto_relacionado'][1]['impuestos_dr'][0]['traslados_dr'][0]['traslado_dr'][0]['importe_dr'] = '240' ;
        ...
        $this->assertStringContainsStringIgnoringCase('<cfdi:Comprobante xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"',$data['xml']);
        $this->assertStringContainsStringIgnoringCase('1500.00" ImpuestoDR="002" TipoFactorDR="xxx"',$data['xml']);
        $this->assertStringContainsStringIgnoringCase('1500.00" ImpuestoDR="002" TipoFactorDR="Tasa"',$data['xml']);
